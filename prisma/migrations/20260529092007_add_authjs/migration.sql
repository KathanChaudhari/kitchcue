/*
  ...
  - You are about to drop the column `liveIn` on the `User` table. All the data in the column will be lost.
  - You are about to drop the column `role` on the `User` table. All the data in the column will be lost.
  - You are about to drop the column `weightKg` on the `User` table. All the data in the column will be lost.
