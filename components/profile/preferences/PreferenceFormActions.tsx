// src/components/profile/preferences/PreferenceFormActions.tsx

import { Save, X } from "lucide-react";

type PreferenceFormActionsProps = {
  isSaving: boolean;
  onCancel: () => void;
};

export function PreferenceFormActions({
  isSaving,
  onCancel
}: PreferenceFormActionsProps) {
  return (
